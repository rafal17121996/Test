...
var Search = () => {
  ...
  var showFindItems = link => history.push({
...
var Result = () => {
  ...
  (0,react.useEffect)(() => {
    unsplash.search.getPhotos({
      ...
      if (result.errors) {
        ...
        console.log(result.response.results.length ? result.response.results : "Not Found");
  ...
  return /*#__PURE__*/react.createElement("section", null, /*#__PURE__*/react.createElement(Link, {
    ...
    to: "/"
  }, "Back"), /*#__PURE__*/react.createElement(Search_Search, null), /*#__PURE__*/react.createElement((build_default()), {
  ...
  }, item.charAt(0).toUpperCase() + item.slice(1), " ", pics.length ? null : "- Not Found"), /*#__PURE__*/react.createElement("div", {
